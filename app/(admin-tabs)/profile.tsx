...
import { Camera, Edit2, Mail, Phone, Save, User } from 'lucide-react-native';
    ...
    >
      ...
      >
          ...
          <View style={[styles.card, { backgroundColor: colors.card }]}>
            ...
            <View style={styles.inputGroup}>
              ...
              >
                ...
                <TextInput
                  style={[
                    styles.input,
                    { color: colors.text, opacity: isEditing ? 1 : 0.7 },
                  ]}
            ...
            >
              {saving ? (
                ...
                <>
                  <Edit2 color="#ffffff" size={20} style={{ marginRight: 8 }} />
        ...
        <View style={styles.section}>
          ...
          <View
            style={[styles.card, { backgroundColor: colors.card, padding: 20 }]}
          >
            ...
            <TouchableOpacity style={styles.contactRow} onPress={openEmail}>
              <View
                style={[styles.contactIconBg, { backgroundColor: '#fef2f2' }]}
              >
            ...
            <TouchableOpacity style={styles.contactRow} onPress={openPhone}>
              <View
                style={[styles.contactIconBg, { backgroundColor: '#f0fdf4' }]}
              >
